...
public:
   ...
   */
  HistogramFeatureWord(const std::vector<double>& histogram = std::vector<double>(),
                       const HistogramDistance<double>* distance = NULL,
  ...
  /** Returns the vector used to represent the mean of different words.
  *   It is used during the KMeans algorithm.
  */
  ...
  /** Returns the similarity between the feature word and a feature vector,
    * considering the weights for each dimension.
    */
