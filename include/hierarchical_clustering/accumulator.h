...
public:
  ...
  /**
    ...
    */
  template<class T>
  T operator/(const KahanAccumulator<T>& acc)
  {
    KahanAccumulator<T> kacc;

    kacc._value = T(this->_value) / acc._value;
  ...
  /**
    ...
    */
  template<class T>
  bool operator<(const KahanAccumulator<T>& acc)
  {
    return this->_value < acc._value;
  }
...
template<class Numeric, class T>
Numeric operator/(const Numeric& lhs, const Accumulator<T>& rhs)
{
  return lhs / rhs._value;
}

template <class T>
inline std::ostream& operator<<(std::ostream& os, const Accumulator<T>& acc)
{
  os << " [ " << T(acc._value) << " ]";
