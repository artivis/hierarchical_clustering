...
template <typename ClusterType>
void KMeansClustering<ClusterType>::clusterPoints(std::vector<ClusterType>& points,
                                                  std::vector<ClusterType>& seeds) const
{
...
template <typename ClusterType>
void KMeansClustering<ClusterType>::clusterPoints(std::vector<ClusterType>& points,
                                                  std::vector<ClusterType>& seeds,
                                                  std::vector< std::vector<unsigned int> >& assignment) const
{
