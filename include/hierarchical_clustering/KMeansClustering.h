...
#include <hierarchical_clustering/HistogramDistances.h>
...
namespace kmeans
{
  template <typename Feature, class Container = std::vector<Feature>,
            class Distance = distance::EuclideanDistance<Feature>,
            class Alloc = vt::DefaultAllocator<Feature> >
  class KMeansClustering
  {
    public:
     ...
     *
     */
    KMeansClustering(uint maxIterations, double minError);
     ...
     *
     */
    void clusterPoints(Container points, Container& seeds) const;
     ...
     *
     */
    void clusterPoints(Container& points, Container& seeds, std::vector< std::vector<unsigned int> >& assignment) const;
     ...
     */
    template<template <typename Type > class Strategy>
    inline void initializeClusters(Container& points, Container& seeds) const
      {Strategy<Feature> initializer; initializer(points, seeds);}
